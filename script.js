...
const account2 = {
  ...
  movementsDates: [
    ...
    "2023-04-28T14:43:26.374Z",
    "2023-05-03T18:49:59.371Z",
...
const displayMovements = function (acc, sort = false) {
  ...
  movs.forEach(function (mov, i) {
    ...
    const displayDate = formatDate(acc.locale, date);
...
const calcDisplaySummary = function (acc) {
  ...
  labelSumIn.textContent = `${income.toFixed(2)}Rs`;
...
btnClose.addEventListener("click", function (e) {
  e.preventDefault();
  // console.log(currentAccount, inputCloseUsername.value);
